...
var _Shafaq = require("./Shafaq.js");
var Astronomical = {
  /* The geometric mean longitude of the sun in degrees. */meanSolarLongitude: function meanSolarLongitude(julianCentury) {
    var T = julianCentury;
  ...
  /* The geometric mean longitude of the moon in degrees. */meanLunarLongitude: function meanLunarLongitude(julianCentury) {
    var T = julianCentury;
  ...
  /* The mean anomaly of the sun. */meanSolarAnomaly: function meanSolarAnomaly(julianCentury) {
    var T = julianCentury;
    /* Equation from Astronomical Algorithms page 163 */
    var term1 = 357.52911;
  ...
  /* The Sun's equation of the center in degrees. */solarEquationOfTheCenter: function solarEquationOfTheCenter(julianCentury, meanAnomaly) {
    var T = julianCentury;
  ...
  /* Mean sidereal time, the hour angle of the vernal equinox, in degrees. */meanSiderealTime: function meanSiderealTime(julianCentury) {
    var T = julianCentury;
    /* Equation from Astronomical Algorithms page 165 */
  ...
  approximateTransit: function approximateTransit(longitude, siderealTime, rightAscension) {
    ...
    var Lw = L * -1;
    var m0 = (0, _MathUtils.normalizeToScale)((a2 + Lw - Theta0) / 360, 1);
    ...
    var expectedTransit = (0, _MathUtils.normalizeToScale)((12.0 - L / 15.0) / 24.0, 1);
  ...
  /* The time at which the sun is at its highest point in the sky (in universal time) */correctedTransit: function correctedTransit(approximateTransit, longitude, siderealTime, rightAscension, previousRightAscension, nextRightAscension) {
  ...
  /* The Julian Day for the given Gregorian date components. */julianDay: function julianDay(year, month, day) {
  ...
  /* Julian century from the epoch. */julianCentury: function julianCentury(julianDay) {
    /* Equation from Astronomical Algorithms page 163 */
  ...
  daysSinceSolstice: function daysSinceSolstice(dayOfYear, year, latitude) {
    var daysSinceSolstice;
    var northernOffset = 10;
    var southernOffset = (0, _DateUtils.isLeapYear)(year) ? 173 : 172;
    var daysInYear = (0, _DateUtils.isLeapYear)(year) ? 366 : 365;
    if (latitude >= 0) {
...
var _default = exports["default"] = Astronomical;
